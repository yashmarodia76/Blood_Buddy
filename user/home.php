    ...
    <div class="container">
      <div id="content-wrap" style="padding-bottom:75px;">
        ...
        <img src="image\_107317099_blooddonor976.jpg" alt="image\_107317099_blooddonor976.jpg" width="100%" height="500">
            ...
            <div class="carousel-item">
              <img src="image\2019-10-21-2.png" alt="image\2019-10-21-2.png" width="100%" height="500">
            </div>
            <div class="carousel-item active">
              <img src="image\Blood-donations.jpg" alt="image\Blood-donation.jpg" width="100%" height="500">
            </div>
        ...
        <br>
        <h1 style="text-align:center;font-size:45px;">Welcome to Zion Blood Bank Manager</h1>
        <br>
        <div class="row">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              <div class="col-lg-4 col-sm-6 portfolio-item"><br>
                <div class="card" style="width:300px">
                  <img class="card-img-top" src="image\donate.jpg" alt="Card image" style="width:100%;height:300px">
                  <div class="card-body">
                    <h3 class="card-title">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <img class="img-fluid rounded" src="image\blood-donation-slogans.png" alt="">
          </div>
        </div>
        <!-- /.row -->
